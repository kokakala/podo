...
<body id="page-top">
  ...
  <script>
  	function detailGo1() { location.href='detailFilm.do?filmId=${ list.get(0).id }'; }
  	function detailGo2() { location.href='detailFilm.do?filmId=${ list.get(1).id }'; }
  	function detailGo3() { location.href='detailFilm.do?filmId=${ list.get(2).id }'; }
  </script>
</body>
